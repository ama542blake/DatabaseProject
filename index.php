...
<div class="jumbotron bg-warning mt-5">
    ...
    <form class="d-flex flex-column" action="search_results.php" method="post">
        <input class="align-self-center form-control"  style="width:85%;text-align:center" type="search">
        <button class="align-self-center btn btn-outline-dark mt-3 mb-2" type="submit" style="width:50%" name="search_query">Search</button>
        <div class="align-self-center">
            ...
            <div class="form-check-inline mt-1">
                <label class="form-check=label"><input class="form-check-input" type="radio" name="searchtype" value="all">All</label>
            </div>
        </div>
