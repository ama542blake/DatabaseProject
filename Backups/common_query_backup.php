<?php
    ...
    /* TODO make this less of a disaster with all these combinations of set an not set attributes. I'm thinking
       some sort of function that builds the query based on if the values for each parameter are null of not.
